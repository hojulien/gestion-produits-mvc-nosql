<?php require_once __DIR__ . '/templates/header.php'; ?>
    ...
    <div class="mx-auto w-full">
        <table class="mx-auto w-full max-w-6xl overflow-x-auto">
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border p-3 text-center">
                        <div class="flex justify-center items-center gap-3">
                            <a class="bg-blue-200 border-2 border-blue-300 rounded-md p-1 shadow-sm" href="?action=produit-view&id=<?= $produit->getId() ?>">
                                <img class="w-8 h-8" src="./assets/icons/view.svg" alt="view icon">
                            </a>
                            <a class="bg-orange-200 border-2 border-orange-300 rounded-md p-1 shadow-sm" href="?action=produit-edit&id=<?= $produit->getId() ?>">
                                <img class="w-8 h-8" src="./assets/icons/edit.svg" alt="edit icon">
                            </a>
                            <a class="bg-red-200 border-2 border-red-300 rounded-md p-1 shadow-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce produit?');" href="?action=delete&id=<?= $produit->getId() ?>">
                                <img class="w-8 h-8" src="./assets/icons/delete.svg" alt="delete icon">
                            </a>
                        </div>
                    </td>
                </tr>
